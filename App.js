...
function App() {
  ...
  const contractAddress = "0x3212F02891e3ECDB6f0bf39BFB2cfcfC189e7878"; // Paste the address recieved from Remix IDE here
      ...
      <header className="App-header">
        ...
        : (
          <div>
            ...
            <div style={{width: '100%', height:'auto', backgroundColor: 'rgba(0,0,0,0.2)', borderRadius:'10px'}}>
